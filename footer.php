...
<div class="container">
     <div class="copyright-txt"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-software');?><?php if( is_home() && is_front_page() || is_home() || is_front_page()) {?>
        <a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-software-wordpress-theme/');?>" target="_blank">
        <?php esc_html_e('SKT Software','skt-software'); ?>
        </a>
        <?php } else {?>
        <?php esc_html_e('SKT Software','skt-software'); ?>
        <?php } ?></div>
